...
public class CodeService {
    ...
    public void shunt(String className, String myPackage, String model, String subModel, String tableDesc,
        ...
        save(tableModel, "template/Pojo.java.ftl", pojoPath,
                className + ".java");
        ...
        daoPath = daoPath+".dao";
        save(tableModel, "template/Dao.java.ftl", daoPath,
                className + "Dao.java");

        // 开始生成Dao.xml文件
        String mapperPath = sqlPath+model;
        save(tableModel, "template/Mapper.xml.ftl", mapperPath, className + "Dao.xml");
        ...
        save(tableModel, "template/Service.java.ftl", servicePath,
        ...
        save(tableModel, "template/Controller.java.ftl", controllerPath, className + "Controller.java");

        // 开始生成页面
        String viewPath = jspPath+model+"."+ StringUtils.toLowerCaseFirstOne(className);
        save(tableModel, "template/Form.jsp.ftl", viewPath,"form.jsp");
        save(tableModel, "template/List.jsp.ftl", viewPath,"list.jsp");
    }
