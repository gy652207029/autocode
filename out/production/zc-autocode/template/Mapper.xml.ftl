...
<#list model.columns as column>
    ...
    <select id="get" resultType="${model.packageName}.${model.model}<#if model.subModel??>.${model.subModel}</#if>.vo.${model.className}">
        SELECT
    ...
    <select id="findList" resultType="${model.packageName}.${model.model}<#if model.subModel??>.${model.subModel}</#if>.vo.${model.className}">
        SELECT
        <include refid="${model.className}Columns"/>
        FROM ${model.tableName} a
    </select>
    ...
    <select id="findPage" resultType="${model.packageName}.${model.model}<#if model.subModel??>.${model.subModel}</#if>.vo.${model.className}">
